...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double mmPerTick = 1 / GoBildaPinpointDriver.GoBildaOdometryPods.goBILDA_SWINGARM_POD.getTicksPerMM();
    ...
    public PinpointLocalizer(HardwareMap hardwareMap, Pose2d initialPose) {
        ...
        driver.setEncoderResolution(1 / PINPOINT_PARAMS.mmPerTick);
        driver.setOffsets(PINPOINT_PARAMS.mmPerTick * PINPOINT_PARAMS.parYTicks, PINPOINT_PARAMS.mmPerTick * PINPOINT_PARAMS.perpXTicks);
        ...
        view = new PinpointViewImpl(this);
    }
