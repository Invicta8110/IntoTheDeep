...
class FollowTrajectoryAsPathAction(
    ...
    private val powerUpdater: Consumer<PoseVelocity2dDual<Time>>,
    private val velocityEstimater: Supplier<PoseVelocity2d>,
    private val positionEstimater: Supplier<Pose2d>
) : Action {
